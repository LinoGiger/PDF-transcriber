...
class PDFTranscriberGUI:
    ...
    def run_process(self) -> None:
        ...
        threading.Thread(target=self._process_pdf_thread, args=(input_path, output_path), daemon=True).start()

    def _process_pdf_thread(self, input_path: str, output_path: str) -> None:
        try:
